...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/datalad-container-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7691&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/datalad-container-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `datalad-container` can be installed with:

```
conda install datalad-container
```

It is possible to list all of the versions of `datalad-container` available on your platform with:
